...
function CourseDetails() {
  ...
  console.log("course details fetched in CourseDetails.jsx" , response?.data[0]);
...
//    isactive karke hamne ek array bana dia hai jo store karta hai ki kon kon se sectiopn open hai
  ...
  const handleBuyCourse = () => {
    if (token) {
        console.log("user in handlebuycourse" , user);
