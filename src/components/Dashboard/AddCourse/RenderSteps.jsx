  ...
  return (
    <>
      <div className="relative mb-2 flex w-full justify-center">
        {
          steps.map((item) => (
            //  dashed line create karne ke lie react.fragemnt use kia hai
        ...
        {/*  yeh code title add karne ke lie hai to all the types of form in react fragments */}
      ...
      {/*  ab form show karna hai according to the step */}
