...
//  ab jo progress baar hota hai uske lie we use ramonak
...
const EnrolledCourses = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.log(" courses are inside EnrolledCourses " , res)
  ...
  //  console.log(" first enroled course ki details " ,enrolledCourses[0].courseContent[0])
