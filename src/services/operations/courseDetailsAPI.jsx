...
export const addCourseDetails = async (data, token) => {
    ...
    try {
        console.log("Token:", token); // Log token to ensure it's being passed correctly
        ...
        console.error("CREATE COURSE API ERROR RESPONSE...............", error.response); // Log full error response
        if (error.response) {
...
export const createSection = async (data, token) => {
    ...
    try {
        ...
        result = response?.data?.updatedCourseDetails
        console.log("result in the coursedeatils api" , result);
...
export const createSubSection = async (data, token) => {
    let result = null
    // console.log("here with data with files " , data.files);
    const toastId = toast.loading("Loading...")
    try {
